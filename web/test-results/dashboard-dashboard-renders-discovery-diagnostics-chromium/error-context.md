...
- Name: dashboard.spec.js >> dashboard >> renders discovery diagnostics
- Location: tests/dashboard.spec.js:25:3
...
Locator: getByText('Discovery Diagnostics')
Expected: visible
Error: strict mode violation: getByText('Discovery Diagnostics') resolved to 2 elements:
    1) <p class="eyebrow">Linux Discovery Diagnostics</p> aka getByText('Linux Discovery Diagnostics')
    2) <h2>Discovery Diagnostics</h2> aka getByRole('heading', { name: 'Discovery Diagnostics' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Discovery Diagnostics')
    ...
    - article [ref=e30]:
      ...
      - generic [ref=e32]:
        ...
        - generic [ref=e36]:
          ...
          - definition [ref=e38]: 4/21/2026, 9:43:23 PM
        - generic [ref=e39]:
