...
- Name: dashboard.spec.js >> dashboard >> renders devices table with correct rows
- Location: tests/dashboard.spec.js:31:3
...
Locator: getByText('Devices')
Expected: visible
Error: strict mode violation: getByText('Devices') resolved to 4 elements:
    1) <span>Devices</span> aka getByTestId('metric-card-devices').getByText('Devices')
    2) <p>…</p> aka getByText('Devices found:')
    3) <h2>Devices</h2> aka getByRole('heading', { name: 'Devices' })
    4) <tr class="clickable-row" data-testid="device-row-3">…</tr> aka getByTestId('device-row-3')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Devices')
    ...
    - article [ref=e30]:
      ...
      - generic [ref=e32]:
        ...
        - generic [ref=e36]:
          ...
          - definition [ref=e38]: 4/21/2026, 9:43:25 PM
        - generic [ref=e39]:
